...
const blocks: Record<TeamPageBlock["__component"], React.ComponentType<{ block: TeamPageBlock }>> = {
	"blocks.spoiler": ({ block }: { block: TeamPageBlock }) => <SpoilerBlock block={block as SpoilerBlock} />,
	"blocks.testimonial": ({ block }: { block: TeamPageBlock }) => <TestimonialBlock block={block as TestimonialBlock} />,
	"blocks.rich-text": ({ block }: { block: TeamPageBlock }) => <RichTextBlock block={block as RichTextBlock} />,
};
